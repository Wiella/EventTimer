...
public final class BackgroundSeparator extends WebSeparator implements Stateful
{
     ...
     */
    public BackgroundSeparator ( final StyleId id, final int orientation, final String settingKey, final String attachmentKey )
    {
    ...
    public List<String> getStates ()
    {
        ...
        if ( settingsKey == null || !SettingsManager.get ( settingsKey, true ) ||
                attachmentKey == null || !SettingsManager.get ( attachmentKey, true ) )
        {
